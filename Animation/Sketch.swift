...
class Sketch {
    ...
    func draw() {
        ...
        canvas.drawEllipse(centreX: x-50, centreY: canvas.height / 2+50, width: 50, height: 50)

        canvas.drawEllipse(centreX: x-100, centreY: canvas.height / 2, width: 50, height: 25)
